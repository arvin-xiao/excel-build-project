...
import cn.arvin.generate.entity.ExcelRow;
import cn.arvin.generate.entity.GenerateProperties;
import cn.arvin.generate.entity.SqlTable;
...
public class ReadExcel {
    ...
    public void outputFile() {
        ...
        FileUtil.writeString(toScriptStr(), new File(properties.getExportSqlDir(), "mysql_script.sql"), StandardCharsets.UTF_8);
    }
